#!/usr/bin/env python3
"""
surface-scan.py — Multi-surface leak detector (Da Vinci's surface matrix).
...
SURFACES (each with its own detector):
  ...
  S7 reachability   — live third-party integrations a stranger could reach
                      (Sen's bar: "can a stranger touch our instance?")
...
def main():
    ...
    # S8 network egress — no-telemetry enforcement (Shaka's point:
